...
if($server=='tuongtaccongdong.com.vn'){
	$key = 'E9892MPHMJC4PN5YPA4SPE855KHER';
}else{
	$key = 'LMTMM9BG5FTPT6VR9X4WG6YXKECB1';
}
$config['licenseName'] = $server;
...
$ssh = !empty($_SERVER['HTTPS']) ? 'https://':'http://';

$config['backends'][] = array(
    'name'         => 'default',
    'adapter'      => 'local',
    'baseUrl'      => $ssh.$_SERVER['HTTP_HOST'].'/upload/tintuc/',
