...
<section class="main main-product">
    <div class="container">
        <div class="row">
            <h2 class="d-none">Dự án nổi bật</h2>
            <div class="col-md-12">
                <div class="row">
                        ...
                        <div class="product-item p-0">
                            <div class="product-avatar">
                                <a href="{{ route('Project',['slugCat'=>$project->categories->slug, 'slugPro'=>$project->slug]) }}" title="Xem chi tiết">
                                    <img src="{{ $project->url_avatar }}" alt="{{ $project->title }}"  class="custom-image-cat">
                                </a>
                            ...
                            <div class="product-content">
                                <div class="product--title">
                                    <a class="color-primary-hv limit-line-2" href="{{ route('Project',['slugCat'=>$project->categories->slug, 'slugPro'=>$project->slug]) }}" title="{{ $project->title }}">
                                        {{ $project->title }}
                                    </a>
                                </div>
                            ...
                            <div class="text-center limit-line-2" style="margin: 10px 10px" title="{{ $project->address }}">
