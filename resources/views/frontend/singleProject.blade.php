...
@push('meta')
    ...
    <meta name="description" property="description" content="{{ $project->meta_description }}">
    <meta name="keywords" property="keywords" content="{{ $project->meta_keyword }}">
    <meta name="csrf-token" content="{{ csrf_token() }}">
    <meta name="iamge" property="image" content="{{ asset($project->avatar) }}">
	...
	<meta property="og:image"         content="{{ asset($project->avatar) }}" />
                                ...
                                <div class="col-lg-6">
                                    <div class="single-p-avatar d-flex align-items-center">
                                        <div class="single-p-avatar-child">
                                            <img src="{{ asset($project->url_avatar) }}" alt="{{ $project->title }}" class="custom-image-cat">
                        ...
                        <div class="col-lg-12">
                            ...
                            <div class="single-product-scroll">
                                ...
                                <div id="hinhanh" class="scroll-section" style="margin-top: 20px;">
                                    ...
                                    @foreach($project->url_images as $key => $image)
                                        <div class="slider-images-project">
                                ...
                                <div id="tags" class="scroll-section">
                                    ...
                                    <div class="d-flex align-content-start flex-wrap mb-10" id="single-tags">
                                        @foreach($tags as $tag)
                                        <a class="content-tag color-white mb-10 zoom" href="{{ route('TagProject', $tag->tags->slug) }}">
                                            {{ $tag->tags->title }}
                                        </a>
                                        @endforeach
                                    </div>
                                </div>
                                <div id="binhluan" class="scroll-section" style="margin-top: 20px; margin-bottom: 20px">
                            ...
                            <div class="related-posts">
                                <div class="row">
                                    ...
                                    <div class="slider-relate owl-carousel owl-theme">
                                    @foreach($project_relate as $related)
                                    
                                        <div class="related-item" style="padding: 10px">
                                            <div class="related-avatar">
                                                <a href="{{ route('Project',['slugCat'=>$related->categories->slug, 'slugPro'=>$related->slug]) }}">
                                                    <img src="{{ asset($related->avatar) }}" class="custom-image-cat zoom" alt="{{ $related->title }}" title="{{ $related->title }}">
                                                </a>
                                            </div>
                                            <div class="related-content">
                                                <div class="related-title">
                                                    <a href="{{ route('Project',['slugCat'=>$related->categories->slug, 'slugPro'=>$related->slug]) }}" style="color: black" class="limit-line-2">
                                                        {{ $related->title }}
                                                    </a>
                                                </div>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
            ...
            <div class="form-group">
              <label class="col-form-label">Số điện thoại(nếu có)</label>
              <input type="text" name="phone" class="form-control inp-comment" placeholder="Nhập số điện thoại">
            </div>
            <div class="form-group">
              <label class="col-form-label">Nội dung bình luận <span class="red">*</span></label>
    ...
    $(document).ready(function () {
        ...
        function updateNavigation() {
            contentSection.each(function () {
                ...
                var navigationPC = $('.single-product-link a[href="#' + sectionName + '"]');
                if (($(this).offset().top - $(window).height() / 2 < $(window).scrollTop()) &&
                    ($(this).offset().top + $(this).height() - $(window).height() / 2 > $(window).scrollTop())) {
                    navigationMatch.addClass('active');
                    navigationPC.addClass('active');
                } else {
                    navigationMatch.removeClass('active');
                    navigationPC.removeClass('active');
                }
            });
        }
