            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="frm-update-new" enctype="multipart/form-data" action="{{ route('EditorNewsPostUpdate',$new->id) }}">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('EditorNewsGetUpdate', $new->id) }}" class="btn btn-brand">Nhập lại</a>
                                        <a href="{{ route('EditorNews') }}" class="btn btn-danger">Quay lại</a>
                                    </div>
                                </form>
                            </div>
