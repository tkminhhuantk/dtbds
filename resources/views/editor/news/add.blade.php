                ...
                <div class="row">
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card flex-row" id="card-header">
                            ...
                            <a href="{{ route('EditorNews') }}">
                            	<span class="btn btn-brand btn-add" data-toggle="modal" data-target="#add-investor">Quay lại</span>
                            </a>
                        </div>
                        <div class="card">
                            <div class="card-body" id="body-add">
                                <form id="frm-add-new" enctype="multipart/form-data" action="{{ route('EditorNewsPostAdd') }}">
                                    @csrf
                                    <div class="alert alert-success d-none" id="mess-add"></div>
                                    <div class="form-group">
                                        <label class="col-form-label">Tiêu đề <span class="red">*</span></label>
                                        <input id="inp-title" type="text" name="title" class="form-control" placeholder="Nhập tên dự án" value="{{ old('title') }}" data-url="{{ route('EditorNewsGetCreateSlug') }}">
                                    ...
                                    <div class="form-group">
                                    	<div class="button-switch d-none">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('EditorNewsGetAdd') }}" class="btn btn-brand color-white">Nhập lại</a>
                                        <a href="{{ route('EditorNews') }}" class="btn btn-danger color-white">Quay lại</a>
                                    </div>
                                </form>
                            </div>
...
<script type="text/javascript">
    ...
    $('#frm-add-new').on('submit', function(e){
        ...
        axios.post(url,data).then(response => {
            $.notify('Thêm thành công bài viết: '+response.data.title, 'success');
