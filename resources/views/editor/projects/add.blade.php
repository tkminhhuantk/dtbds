                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="card">
                            <div class="card-body" id="body-add">
                                ...
                                <form id="frm-add-project" enctype="multipart/form-data" action="{{ route('EditorProjectsPostAdd') }}" method="post">
                                    @csrf
                                    <div class="form-group">
                                        <label class="col-form-label">Tiêu đề <span class="red">*</span></label>
                                        <input id="inp-title" type="text" name="title" class="form-control" placeholder="Nhập tên dự án" value="{{ old('title') }}" data-url="{{ route('EditorProjectsGetCreateSlug') }}">
                                        @error('title')
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('EditorProjectsGetAdd') }}"><span class="btn btn-brand">Nhập lại</span></a>
