                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        <div class="card flex-row" id="card-header">
                            <h5 class="card-header ff-google fw-bold">THÊM TAGS MỚI</h5>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <form id="frm-add-tag" enctype="multipart/form-data" action="{{ route('EditorTagsPostAdd') }}" method="post">
                                    @csrf
                                    <div class="form-group">
                                        <label class="col-form-label">Tên tags <span class="red">*</span></label>
                                        <input type="text" name="title" class="form-control" placeholder="Vui lòng nhập tên tag" value="">
                                        <div class="alert alert-danger d-none" id="inp-title-error"></div>
                                    </div>

                                    <div class="form-group">
                                        <label class="col-form-label">Slug</label>
                                        <input type="text" name="slug" class="form-control" placeholder="Vui lòng nhập đường dẫn tag" value="">
                                        <div class="alert alert-danger d-none" id="inp-slug-error"></div>
                                    </div>

                                    <div class="form-group">
                                        <label>Mô tả</label>
                                        <textarea name="description" class="form-control" rows="8" placeholder="Vui lòng nhập mô tả"></textarea>
                                        <div class="alert alert-danger d-none" id="inp-description-error"></div>
                                    </div>

                                    <div class="form-group">
                                        <button class="btn btn-info" type="submit">Lưu lại</button>
                                        <a href="{{ route('EditorTags') }}" class="btn btn-brand color-white">Nhập lại</a>
                                    </div>
                                </form>
                            </div>
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="table-responsive">
                                    ...
                                    <table class="table table-striped table-bordered first" id="tbl-tags" data-url="">
                                        <thead>
                                            <tr>
                                        ...
                                        <tbody>
                                            ...
                                            <tr>
                                                ...
                                                <td class="text-center">
                                                    <a href="{{ route('EditorTagsGetUpdate', $tag->id) }}"><span class="btn btn-primary" title="Chỉnh sủa"><i class="fas fa-edit"></i></span></a>
                                                </td>
                                            </tr>
                                            @endforeach
                                        </tbody>
