            ...
            <div class="container-fluid  dashboard-content">
                ...
                <div class="row">
                    <div class="col-lg-4 col-md-4 col-sm-12">
                        ...
                        <div class="card">
                            <div class="card-body">
                                <form id="frm-add-tag" enctype="multipart/form-data" action="{{ route('AdminTagsPostAdd') }}" method="post">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                        ...
                                        <a href="{{ route('AdminTags') }}" class="btn btn-brand color-white">Nhập lại</a>
                                    </div>
                                </form>
                            </div>
