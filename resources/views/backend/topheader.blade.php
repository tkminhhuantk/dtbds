...
@endphp
        <div class="dashboard-header">
            <nav class="navbar navbar-expand-lg bg-white fixed-top">
                <a class="navbar-brand fs-19 color-primary" href="{{ route('Home') }}" target="_blank">
                    <img src="{{ asset($config->logo) }}" style="height: 40px; width: auto">
                </a>
                        ...
                        <li class="nav-item dropdown nav-user">
                            ...
                            <div class="dropdown-menu dropdown-menu-right nav-user-dropdown" aria-labelledby="navbarDropdownMenuLink2">
                                <div class="nav-user-info">
                                    <h5 class="mb-0 text-white nav-user-name ff-google">{{ $user->name }}</h5>
                                ...
                                <a class="dropdown-item" href="{{ route('UsersGetMyAccount') }}"><i class="fas fa-user mr-2"></i>Thông tin cá nhân</a>
                                <a class="dropdown-item" href="{{ route('UsersList') }}"><i class="fas fa-user mr-2"></i>Quản lý tài khoản</a>
