                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        <div class="card">
                            <div class="card flex-row" id="card-header">
                                <h5 class="card-header ff-google fw-bold">CẬP NHẬT TÀI KHOẢN</h5>
                                    ...
                                    <div class="row">
                                        <div class="col-md-8 offset-md-2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="name" id="name" value="{{ $user->name }} " placeholder="Vui lòng nhập họ và tên" class="form-control">
                                                <div class="err d-none red" id="err-name"></div>
                                            </div>
                                            <div class="form-group">
                                                <label for="email">Email (dùng để đăng nhập)<span class="red">*</span></label>
                                                <input type="text" name="email" id="email" value="{{ $user->email }}" placeholder="Vui lòng nhập email" class="form-control" disabled="disabled">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" name="phone" id="phone" placeholder="Vui lòng nhập số điện thoại" class="form-control" value="{{ $user->phone }}">
                                            </div>
                                            <div class="form-group">
                                                <label for="excerpt">Mô tả</label>
                                                <textarea name="excerpt" id="excerpt" rows="3" placeholder="Vui lòng nhập mô tả" class="form-control">{{ $user->excerpt }}</textarea>
                                            </div> 
                                            <div class="form-group">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <select name="permission" id="permission" class="form-control">
                                                    ...
                                                    @foreach($permissions as $pms)
                                                        @if($pms->id == $user->permission)
                                                        <option value="{{ $pms->id }}" selected="selected">{{ $pms->title }}</option>
                                                        @else
