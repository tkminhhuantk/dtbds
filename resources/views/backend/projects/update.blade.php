                    ...
                    <div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
                        ...
                        <div class="card" >
                            <div class="card-body" id="body-add">
                                ...
                                <form id="frm-update-project" enctype="multipart/form-data" action="{{ route('ProjectsPostUpdate', $project->id) }}" method="post">
                                    @csrf
...
const upload = new CustomUpload('#fileImage');
    ...
    $('.ct-img-slider').on('click', '.btn-del-slider', function(){
        let url = $(this).attr('data-url');
        let id = $(this).attr('data-id');
        let image = $(this).attr('data-image');
        axios.post(url, {id: id, image: image}, {
            headers: {
